...
export async function execute(
    ...
    const getResult = (): Promise<StoryLoadResult> =>
        browser.executeAsync(executeOpenStoryScript, storyId, remountOnly).then(JSON.parse);
...
function openStoryScript(storyId: string, remountOnly: boolean, done: (result: string) => void): void {
